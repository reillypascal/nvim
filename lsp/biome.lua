...
return {
	...
	-- needed to turn this off to get server to start
	workspace_required = false,
	-- needed to remove this to get any highlighting
	...
	-- 	on_dir(project_root)
	-- end,
	-- https://www.reddit.com/r/neovim/comments/1of6lzt/has_anyone_gotten_the_biome_lsp_setup_with_the/
