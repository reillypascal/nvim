...
return {
	...
	event = {
		...
		"BufReadPre " .. vim.fn.expand("~") .. "/Sync/Notes/*.md",
		"BufNewFile " .. vim.fn.expand("~") .. "/Sync/Notes/*.md",
		"BufReadPre " .. vim.fn.expand("~") .. "/Sync/Personal/*.md",
		"BufNewFile " .. vim.fn.expand("~") .. "/Sync/Personal/*.md",
		"BufReadPre " .. vim.fn.expand("~") .. "/Sync (Household)/*.md",
		"BufNewFile " .. vim.fn.expand("~") .. "/Sync (Household)/*.md",
	},
	---@module 'obsidian'
